...
//Funcao de repeticao referente ao movimento do cavalo
void funcaocavalo (){

    //Decalaração de variáveis
    int cavalo = 1;
    int totalCasasEsquerda = 0;
    int totalCasasBaixo = 0;
    ...
    printf("O total de casas percorridas pelo cavalo foi de %d casas para baixo e %d casas para a esquerda.\n", totalCasasBaixo, totalCasasEsquerda);
